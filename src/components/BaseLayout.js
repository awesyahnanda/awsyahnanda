...
export default function BaseLayout() {
   ...
   return (
      <Box className={darkMode ? Style.dark : Style.light} minWidth={100} minHeight={'screen'}>
         <Grid container display={'flex'} flexDirection={'column'} minWidth={100} minHeight={'100vh'}
